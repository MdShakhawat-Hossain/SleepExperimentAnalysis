function [AnalysisResults] = AnalyzeCrossCorrelation_GRABNE_CBV(animalID,rootFolder,AnalysisResults,firstHrs)

% function parameters & data types
dataTypes = {'NE_GFP'}; % 'Ach_Rhodamine','NE_Rhodamine','Ach_GFP',
pupilDataTypes = {'Ach_Rhodamine','NE_Rhodamine','Ach_GFP','NE_GFP'};
modelType = 'Manual';
...
for aa = 1:length(dataTypes)
    ...
    for bb = 1:length(pupilDataTypes)
        ...
        [restLogical] = FilterEvents_JNeurosci2022(RestData.GFP.Z_NE,RestCriteria);
        [puffLogical] = FilterEvents_JNeurosci2022(RestData.GFP.Z_NE,RestPuffCriteria);
        ...
        if strcmp(pupilDataType,'Ach_Rhodamine') == true
            pupilRestData = RestData.Rhodamine.Z_Ach.data(combRestLogical,1);
        elseif strcmp(pupilDataType,'NE_Rhodamine') == true
            pupilRestData = RestData.Rhodamine.Z_NE.data(combRestLogical,:);
        elseif strcmp(pupilDataType,'Ach_GFP') == true
            pupilRestData = RestData.GFP.Z_Ach.data(combRestLogical,:);
        elseif strcmp(pupilDataType,'NE_GFP') == true
            pupilRestData = RestData.GFP.Z_NE.data(combRestLogical,:);
        ...
        if strcmp(dataType,'Ach_Rhodamine') == true
            restData = RestData.Rhodamine.Z_Ach.data(combRestLogical,1);
        ...
        for cc = 1:size(procDataFileIDs,1)
            ...
            if sum(strcmp(scoringLabels,'Not Sleep')) > 436 % 70% of the time awake
                ...
                if strcmp(ProcData.data.Pupil.diameterCheck,'y') == true
                    ...
                    if isempty(puffs) == true
                        if sum(isnan(ProcData.data.Pupil.zDiameter)) == 0
                            ...
                            if strcmp(dataType,'Ach_Rhodamine') == true
                                alertData{zz,1} = ProcData.data.Rhodamine.Z_Ach;
                            elseif strcmp(dataType,'NE_Rhodamine') == true
                                alertData{zz,1} = ProcData.data.Rhodamine.Z_NE;
                            elseif strcmp(dataType,'Ach_GFP') == true
                                alertData{zz,1} = ProcData.data.GFP.Z_Ach;
                            elseif strcmp(dataType,'NE_GFP') == true
                                alertData{zz,1} = ProcData.data.GFP.Z_NE;
                            % elseif strcmp(dataType,'zDiameter') == true
                            ...
                            if strcmp(pupilDataType,'Ach_Rhodamine') == true
                                alertPupilData{zz,1} = ProcData.data.Rhodamine.Z_Ach;
                            elseif strcmp(pupilDataType,'NE_Rhodamine') == true
                                alertPupilData{zz,1} = ProcData.data.Rhodamine.Z_NE;
                            elseif strcmp(pupilDataType,'Ach_GFP') == true
                                alertPupilData{zz,1} = ProcData.data.GFP.Z_Ach;
                            elseif strcmp(pupilDataType,'NE_GFP') == true
                                alertPupilData{zz,1} = ProcData.data.GFP.Z_NE;
                            % elseif strcmp(pupilDataType,'zDiameter') == true
        ...
        for cc = 1:size(procDataFileIDs,1)
            ...
            % check labels to match arousal state
            if sum(strcmp(scoringLabels,'Not Sleep')) < 312 % 50% of the time sleep
                load(procDataFileID,'-mat')
                % only run on files with good pupil measurement
                if strcmp(ProcData.data.Pupil.diameterCheck,'y') == true
                    try
                    ...
                    if isempty(puffs) == true
                        if sum(isnan(ProcData.data.Pupil.zDiameter)) == 0
                            ...
                            % pull data based on pupil data type
                            if strcmp(pupilDataType,'Ach_Rhodamine') == true
                                asleepPupilData{zz,1} = ProcData.data.Rhodamine.Z_Ach;
                            elseif strcmp(pupilDataType,'NE_Rhodamine') == true
                                asleepPupilData{zz,1} = ProcData.data.Rhodamine.Z_NE;
                            elseif strcmp(pupilDataType,'Ach_GFP') == true
                                asleepPupilData{zz,1} = ProcData.data.GFP.Z_Ach;
                            elseif strcmp(pupilDataType,'NE_GFP') == true
                                asleepPupilData{zz,1} = ProcData.data.GFP.Z_NE;
                            % elseif strcmp(pupilDataType,'zDiameter') == true
            ...
            if strcmp(ProcData.data.Pupil.diameterCheck,'y') == true
                ...
                if isempty(puffs) == true
                    if sum(isnan(ProcData.data.Pupil.zDiameter)) == 0
                            ...
                            % pull data based on pupil data type
                            if strcmp(pupilDataType,'Ach_Rhodamine') == true
                                allPupilData{zz,1} = ProcData.data.Rhodamine.Z_Ach;
                            elseif strcmp(pupilDataType,'NE_Rhodamine') == true
                                allPupilData{zz,1} = ProcData.data.Rhodamine.Z_NE;
                            elseif strcmp(pupilDataType,'Ach_GFP') == true
                                allPupilData{zz,1} = ProcData.data.GFP.Z_Ach;
                            elseif strcmp(pupilDataType,'NE_GFP') == true
                                allPupilData{zz,1} = ProcData.data.GFP.Z_NE;
                            % elseif strcmp(pupilDataType,'zDiameter') == true
        ...
        if isempty(SleepData.(modelType).NREM.data.Pupil) == false
            ...
            if strcmp(dataType,'Ach_Rhodamine') == true
                [NREM_finalData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).NREM.data.Rhodamine.Z_Ach,SleepData.(modelType).NREM.FileIDs,SleepData.(modelType).NREM.BinTimes);
            elseif strcmp(dataType,'NE_Rhodamine') == true
                [NREM_finalData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).NREM.data.Rhodamine.Z_NE,SleepData.(modelType).NREM.FileIDs,SleepData.(modelType).NREM.BinTimes);
            elseif strcmp(dataType,'Ach_GFP') == true
                [NREM_finalData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).NREM.data.GFP.Z_Ach,SleepData.(modelType).NREM.FileIDs,SleepData.(modelType).NREM.BinTimes);
            elseif strcmp(dataType,'NE_GFP') == true
                [NREM_finalData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).NREM.data.GFP.Z_NE,SleepData.(modelType).NREM.FileIDs,SleepData.(modelType).NREM.BinTimes);
            % elseif strcmp(dataType,'zDiameter') == true
            ...
            if strcmp(pupilDataType,'Ach_Rhodamine') == true
                [NREM_finalPupilData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).NREM.data.Rhodamine.Z_Ach,SleepData.(modelType).NREM.FileIDs,SleepData.(modelType).NREM.BinTimes);
            elseif strcmp(pupilDataType,'NE_Rhodamine') == true
                [NREM_finalPupilData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).NREM.data.Rhodamine.Z_NE,SleepData.(modelType).NREM.FileIDs,SleepData.(modelType).NREM.BinTimes);
            elseif strcmp(pupilDataType,'Ach_GFP') == true
                [NREM_finalPupilData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).NREM.data.GFP.Z_Ach,SleepData.(modelType).NREM.FileIDs,SleepData.(modelType).NREM.BinTimes);
            elseif strcmp(pupilDataType,'NE_GFP') == true
                [NREM_finalPupilData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).NREM.data.GFP.Z_NE,SleepData.(modelType).NREM.FileIDs,SleepData.(modelType).NREM.BinTimes);
            % elseif strcmp(pupilDataType,'zDiameter') == true
      ...
      if firstHrs == "false"   
        if isempty(SleepData.(modelType).REM.data.Pupil) == false
            ...
            if strcmp(dataType,'Ach_Rhodamine') == true
                [REM_finalData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).REM.data.Rhodamine.Z_Ach,SleepData.(modelType).REM.FileIDs,SleepData.(modelType).REM.BinTimes);
            elseif strcmp(dataType,'NE_Rhodamine') == true
                [REM_finalData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).REM.data.Rhodamine.Z_NE,SleepData.(modelType).REM.FileIDs,SleepData.(modelType).REM.BinTimes);
            elseif strcmp(dataType,'Ach_GFP') == true
                [REM_finalData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).REM.data.GFP.Z_Ach,SleepData.(modelType).REM.FileIDs,SleepData.(modelType).REM.BinTimes);
            elseif strcmp(dataType,'NE_GFP') == true
                [REM_finalData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).REM.data.GFP.Z_NE,SleepData.(modelType).REM.FileIDs,SleepData.(modelType).REM.BinTimes);
            % elseif strcmp(dataType,'zDiameter') == true
            ...
            if strcmp(pupilDataType,'Ach_Rhodamine') == true
                [REM_finalPupilData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).REM.data.Rhodamine.Z_Ach,SleepData.(modelType).REM.FileIDs,SleepData.(modelType).REM.BinTimes);
            elseif strcmp(pupilDataType,'NE_Rhodamine') == true
                [REM_finalPupilData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).REM.data.Rhodamine.Z_NE,SleepData.(modelType).REM.FileIDs,SleepData.(modelType).REM.BinTimes);
            elseif strcmp(pupilDataType,'Ach_GFP') == true
                [REM_finalPupilData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).REM.data.GFP.Z_Ach,SleepData.(modelType).REM.FileIDs,SleepData.(modelType).REM.BinTimes);
            elseif strcmp(pupilDataType,'NE_GFP') == true
                [REM_finalPupilData,~,~] = RemoveStimSleepData_IOS(animalID,SleepData.(modelType).REM.data.GFP.Z_NE,SleepData.(modelType).REM.FileIDs,SleepData.(modelType).REM.BinTimes);
            % elseif strcmp(pupilDataType,'zDiameter') == true
