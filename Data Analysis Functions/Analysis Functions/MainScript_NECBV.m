function [] = MainScript_NECBV()
%%
clear; clc; close all;
%% Animal IDs
FP_animalIDs =    {'NEACh039'};%,'NEACh010','NEACh011'};%,'NEAChGi001','NEAChGi002','NEAChChR2002'};
...
[AnalysisResults] = Fig1_S3_Whisk_GRABNE_Response_CI_OnlyCBV(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FP_animalIDs);
...
% [AnalysisResults] = Fig1_S9_OptoStim_GRABNE_Response_CI_SleepDetected_GFP(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FP_animalIDs);

% [AnalysisResults] = Fig1_S9_OptoStim_GRABNE_Response_CI_SleepDetected_OnlyCBV(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FP_animalIDs);

% [AnalysisResults] = Fig1_S5_Movement_GRABNE_Response_CI_OnlyCBV(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FP_animalIDs);
% [AnalysisResults] = Fig1_S5_Movement_GRABNE_Response_CI(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FP_animalIDs);

% [AnalysisResults] = Fig4_FP_Transition_GRABNE_SingleMouse_consolidated_CI_onlyCBV(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FP_animalIDs);
...
% [AnalysisResults] = Fig4_FP_Transition_GRABNE_SingleMouse_CaMKIIa(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FP_animalIDs);
