...
OptoStim_Yvals = ones(size(OptoStim));
% set force indeces
...
% Sleep Score data
ax4 = subplot(9,1,1);
s1 = scatter(SleepDummy/60',AwakeStage,'s','MarkerFaceColor','k','MarkerEdgeColor','k');
hold on
s2 = scatter(SleepDummy/60',NREMStage,'s','MarkerFaceColor',[0.3010 0.7450 0.9330],'MarkerEdgeColor',[0.3010 0.7450 0.9330]);
s3 = scatter(SleepDummy/60',REMStage,'s','MarkerFaceColor','r','MarkerEdgeColor','r');
s4 = scatter(OptoStim/60,OptoStim_Yvals,'s','MarkerFaceColor','m','MarkerEdgeColor','m');
legend([s1,s2,s3,s4],'Awake','NREM','REM','Opto')
set(gca,'Xticklabel',[])
set(gca,'Yticklabel',[])
...
% Green
ax5 = subplot(9,1,[3:5]);
s1 = scatter(SleepDummy/60',AwakeStage + max(filtACh_GFP) ,'s','MarkerFaceColor','k','MarkerEdgeColor','k');
hold on
s2 = scatter(SleepDummy/60',NREMStage + max(filtACh_GFP) ,'s','MarkerFaceColor',[0.3010 0.7450 0.9330],'MarkerEdgeColor',[0.3010 0.7450 0.9330]);
s3 = scatter(SleepDummy/60',REMStage + max(filtACh_GFP) ,'s','MarkerFaceColor','r','MarkerEdgeColor','r');
% legend([s1,s2,s3],'Awake','NREM','REM')
plot((1:length(filtACh_GFP))/(resample_rate*60),filtACh_GFP,'color',[0 0.4470 0.7410],'LineWidth',1);
ylim([-3 4])
...
%% CBV
ax6 = subplot(9,1,[7:9]);
s1 = scatter(SleepDummy/60',AwakeStage + max(filtNE_CBV) ,'s','MarkerFaceColor','k','MarkerEdgeColor','k');
hold on
s2 = scatter(SleepDummy/60',NREMStage + max(filtNE_CBV) ,'s','MarkerFaceColor',[0.3010 0.7450 0.9330],'MarkerEdgeColor',[0.3010 0.7450 0.9330]);
s3 = scatter(SleepDummy/60',REMStage + max(filtNE_CBV) ,'s','MarkerFaceColor','r','MarkerEdgeColor','r');
% legend([s1,s2,s3],'Awake','NREM','REM')
plot((1:length(filtACh_CBV))/(resample_rate*60),filtACh_CBV,'color',[0.1350 0.0780 0.6840],'LineWidth',1);
ylim([-3 5])
