function [AnalysisResults] = Fig1_S9_OptoStim_GRABNE_Response_CI_SleepDetected_OnlyCBV(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FPanimalIDs)
...
ax3.YAxis(2).Color = 'k';
xlabel('Peri-stimulus time (s)')
% legend([p2,p1,p3],'Contra', 'Ipsi','Pupil','Location','best')
set(gca,'box','off')
...
ax7.YAxis(2).Color = 'k';
xlabel('Peri-stimulus time (s)')
% legend([p1,p2,p3],'Contra', 'Ipsi','Pupil','Location','best')
set(gca,'box','off')
