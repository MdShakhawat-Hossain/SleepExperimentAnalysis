function [AnalysisResults] = PlotpowerSpectrum_GRABNE_RNR(rootFolder,saveFigs,delim,AnalysisResults,animalIDs)
...
%     ax4.TickLength = [0.03,0.03];
    ...
    if strcmp(saveFigs,'y') == true
        ...
        savefig(powerSpec_Fig,[dirpath 'Fig_PowerSpectrum_RestNREMREM']);
        set(powerSpec_Fig,'PaperPositionMode','auto');
        print('-painters','-dpdf','-fillpage',[dirpath 'Fig_PowerSpectrum_RestNREMREM'])
    end
    close
