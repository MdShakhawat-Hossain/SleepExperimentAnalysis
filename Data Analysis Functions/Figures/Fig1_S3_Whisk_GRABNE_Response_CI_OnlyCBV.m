function [AnalysisResults] = Fig1_S3_Whisk_GRABNE_Response_CI_OnlyCBV(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,animalIDs)
...
% p1 = plot(data.ShortWhisks.meanTimeVector,data.ShortWhisks.P_CBV_Mean,'-','color','red','LineWidth',2);
% hold on
...
% p2 = plot(data.IntermediateWhisks.meanTimeVector,data.IntermediateWhisks.P_CBV_Mean,'-','color','red','LineWidth',2);
% hold on
