function [AnalysisResults] = Fig1_S9_OptoStim_GRABNE_Response_CI_SleepDetected_GFP(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FPanimalIDs)
...
yyaxis right
p4 = plot(data.AllOptoStim.mean_timeVector,data.AllOptoStim.P_NEGFP_Mean,'-','color',[0.4660 0.6740 0.1880],'LineWidth',2);
hold on
NEn =  data.AllOptoStim.P_NEGFP_Mean + data.AllOptoStim.P_NEGFP_yCI95;
patch([data.AllOptoStim.mean_timeVector' fliplr(data.AllOptoStim.mean_timeVector')], [NEn(1,:) fliplr(NEn(2,:))],[0.4660 0.6740 0.1880],'FaceColor',[0.4660 0.6740 0.1880],'EdgeColor','none','LineWidth',0.1,'FaceAlpha',0.2);
...
legend([p1,p2,p3,p4],'LH', 'RH','Pupil','NE','Location','best')
set(gca,'box','off')
...
p4 = plot(data.NoSleep_OptoStim.mean_timeVector,data.NoSleep_OptoStim.P_NEGFP_Mean,'-','color',[0.4660 0.6740 0.1880],'LineWidth',2);
hold on
NEn =  data.NoSleep_OptoStim.P_NEGFP_Mean + data.NoSleep_OptoStim.P_NEGFP_yCI95;
patch([data.NoSleep_OptoStim.mean_timeVector' fliplr(data.NoSleep_OptoStim.mean_timeVector')], [NEn(1,:) fliplr(NEn(2,:))],[0.4660 0.6740 0.1880],'FaceColor',[0.4660 0.6740 0.1880],'EdgeColor','none','LineWidth',0.1,'FaceAlpha',0.2);
...
yyaxis right
p4 = plot(data.CauseArousal_OptoStim.mean_timeVector,data.CauseArousal_OptoStim.P_NEGFP_Mean,'-','color',[0.4660 0.6740 0.1880],'LineWidth',2);
hold on
NEn =  data.CauseArousal_OptoStim.P_NEGFP_Mean + data.CauseArousal_OptoStim.P_NEGFP_yCI95;
patch([data.CauseArousal_OptoStim.mean_timeVector' fliplr(data.CauseArousal_OptoStim.mean_timeVector')], [NEn(1,:) fliplr(NEn(2,:))],[0.4660 0.6740 0.1880],'FaceColor',[0.4660 0.6740 0.1880],'EdgeColor','none','LineWidth',0.1,'FaceAlpha',0.2);
...
p4 = plot(data.CauseSleep_OptoStim.mean_timeVector,data.CauseSleep_OptoStim.P_NEGFP_Mean,'-','color',[0.4660 0.6740 0.1880],'LineWidth',2);
hold on
NEn =  data.CauseSleep_OptoStim.P_NEGFP_Mean + data.CauseSleep_OptoStim.P_NEGFP_yCI95;
patch([data.CauseSleep_OptoStim.mean_timeVector' fliplr(data.CauseSleep_OptoStim.mean_timeVector')], [NEn(1,:) fliplr(NEn(2,:))],[0.4660 0.6740 0.1880],'FaceColor',[0.4660 0.6740 0.1880],'EdgeColor','none','LineWidth',0.1,'FaceAlpha',0.2);
