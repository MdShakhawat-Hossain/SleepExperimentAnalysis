function [AnalysisResults] = Fig1_S3_Whisk_Flavoprotein_Response_CI(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,animalIDs)
...
ylim([-.5 1])
xlim([-5 15])
legend([p1, p2, p3, p4],'CBV-LH','CBV-RH','ACh','NE')
