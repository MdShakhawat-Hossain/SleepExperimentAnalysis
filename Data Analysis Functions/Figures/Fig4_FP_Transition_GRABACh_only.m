function [AnalysisResults] = Fig4_FP_Transition_GRABACh_only(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FPanimalIDs)
...
xlabel({'Time (s)'})
    ...
    legend('ACh','Location','northeast','FontSize',5)
...
if strcmp(saveFigs,'y') == true
    ...
    savefig(summaryFigure_D,[dirpath ManipulationType '_Transition_ACh']);
    set(summaryFigure_D,'PaperPositionMode','auto');
    print('-painters','-dpdf','-fillpage',[dirpath ManipulationType '_Transition_ACh'])
end
close
