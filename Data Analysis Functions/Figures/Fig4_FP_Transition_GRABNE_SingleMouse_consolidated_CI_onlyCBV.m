function [AnalysisResults] = Fig4_FP_Transition_GRABNE_SingleMouse_consolidated_CI_onlyCBV(rootFolder,saveFigs,delim,AnalysisResults,firstHrs,FPanimalIDs)
...
% Blood Volume and NE, ACh
    ...
    legend([pC],'CBV','Location','northeast','FontSize',5)
